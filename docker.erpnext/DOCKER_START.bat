...
docker run -d --name %CONTAINER_NAME% -h "%HOST_NAME%" -p %IMAGE_PORT%:%IMAGE_PORT% -v /home/frappe/frappe-bench/sites/site1.local/ -v /var/lib/mysql %IMAGE_TAG%
...
REM ECHO User 		=	%IMAGE_USER%
REM ECHO Pass		= 	%IMAGE_PASS%
