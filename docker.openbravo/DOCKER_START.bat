...
SET CONTAINER_NAME=openbravo

SET IMAGE_TAG=mohdshaiza/openbravo-server
SET IMAGE_USER=openbravo
SET IMAGE_PASS=openbravo
SET IMAGE_PORT=8080
...
REM docker run -d -e POSTGRES_USER=%IMAGE_USER% -e POSTGRES_PASSWORD=%IMAGE_PASS% --name db postgres:9.4
